...
enum FMRecommendApi{
    ...
    case changePaiCategoryList//更换精品
...
extension FMRecommendApi:TargetType{
    ...
    var path : String{
        ...
        case .changePaiCategoryList: return "/mobile/discovery/v1/guessYouLike/paidCategory/ts-1535167980873"
