...
class FMHomeRecommendLiveCell: UICollectionViewCell {
    ...
    private lazy var changeBtn:UIButton = {
        ...
        button.setTitleColor(UIColor.init(red: 242/255.0, green: 77/255.0, blue: 51/255.0, alpha: 1), for: UIControlState.normal)
...
extension FMHomeRecommendLiveCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
